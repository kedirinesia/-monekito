...
class _TransactionDetailsPageState extends State<TransactionDetailsPage> {
  List<ListTileActionItem> _getPayActions(
    ...
    payTransaction(DateTime datetime) async {
      ...
      // Validate balance for expense transactions and outgoing transfers before processing payment
      if (transaction.type == TransactionType.E || transaction.type == TransactionType.T) {
        ...
        if (!isValid) {
          debugPrint('[TransactionDetails] INSUFFICIENT BALANCE! Blocking payment processing.');
          return;
        }
      }

...
enum CategoryType {
  /// This type of category only supports pengeluaran
  E,

  /// This type of category only supports pendapatan
  I,

  /// This type of category supports pendapatan and pengeluaran
  B;
